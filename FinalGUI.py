...
class InventoryGUI:
    ...
    def add_product(self):
        ...
        self.inventory_system.add_product(name, price, stock)
        self.clear_entries()

    def delete_product(self):
        product_id = int(self.delete_id_entry.get())
        self.inventory_system.delete_product_by_id(product_id)
        self.clear_entries()

    def sell_product(self):
        product_id = int(self.product_id_entry.get())
        quantity = int(self.quantity_entry.get())
        self.inventory_system.sell_product_by_id(product_id, quantity)
        self.clear_entries()

    def restock_product(self):
        product_id = int(self.product_id_entry.get())
        quantity = int(self.quantity_entry.get())
        self.inventory_system.restock_product_by_id(product_id, quantity)
        self.clear_entries()
    ...
    def display_sales(self):
        ...
        self.display_window("Sales", sales_data)
        self.clear_entries()
